def Housman(data, nMFW = 1000, culling = 0, Kernels = 'all', chunks = 1, summary = True):
    ...
    '''
    dfList = []
    import pandas as pd; import string; import collections; from sklearn import svm; from os import listdir
...
def Genre_Prep(data):
    import pandas as pd; import itertools; from copy import deepcopy
    #data = '/Users/nate/Documents/Academia/PhD Search/Test Corpus'             TROUBLESHOOTING LINE
